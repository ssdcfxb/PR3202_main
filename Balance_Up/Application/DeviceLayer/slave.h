...
typedef __packed struct slv_tx_info_struct {
	...
	uint16_t status;	//1:遥控器(0:关 1:开) 2:弹仓(0:关 1:开) 3:小陀螺(0:关 1:开) 4:换头(0:5110 1:1014) 5:换头标志位(0:完成换头 1:开始换头) 6:自瞄(0:关 1:开) 7:复位(0:关 1:开) 8:侧身(0:关 1:开)
	                  //9:加速(0:关 1:开) 10:打符(0:关 1:开)	11:陀螺仪状态(0:正常 1:有问题)
	float    imu_angle;
	int16_t  motor_angle;
	uint16_t CRC16;
