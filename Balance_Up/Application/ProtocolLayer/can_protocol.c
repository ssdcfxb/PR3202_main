...
void CAN_SendAll(void)
{
	...
	CAN1_Send_With_int16_to_uint8(RM_motor[FRIC_L].id.tx_id, can2_send_buf);
	CAN2_Send_With_int16_to_uint8(RM_motor[GIM_P].id.tx_id, can1_send_buf);
